...
L_4195:
	...
	ld hl,0e1bdh		;41b1
	ld de,039f1h		;41b4
	call L_66E2		;41b7   ; y la altura alcanzada
...
L_44B0:
	...
	push af			;44b3
	call nz,L_4445		;44b4   ; bit 7 puesto -> copiar n bytes tal cual
	pop af			;44b7
